...
<script type="text/javascript" src="<%=request.getContextPath() %>/static/js/jquery2.min.js"></script>
<script>
	/*
	 * 注意：
...
<script src="<%=request.getContextPath()%>/static/js/zepto.min.js"></script>
